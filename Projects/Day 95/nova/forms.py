...
class ProflePictureForm(forms.ModelForm):
    ...
    homepage_link = forms.CharField(label="Home Page Link", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder' : ' Link'}))
    ...
    class Meta:
        model = Profile
        fields = ('profile_image', 'homepage_link', 'facebook_link', 'instagram_link', 'linkedin_link')

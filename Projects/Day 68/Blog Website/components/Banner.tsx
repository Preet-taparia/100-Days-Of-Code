...
function SampleNextArrow(props: any) {
  ...
  return (
    <div
      className="w-44 h-10 absolute bottom-32 z-30 right-10 border-[1px] border-gray-900 px-2 hover:border-gray-800 bg-black/50 hover:bg-black shadow-btnShadow overflow-hidden"
      onClick={onClick}
    >
...
function SamplePrevArrow(props: any) {
  ...
  return (
    <div
      className="w-44 h-10 absolute bottom-32 z-30 left-10 border-[1px] border-gray-900 px-2 hover:border-gray-800 bg-black/50 hover:bg-black shadow-btnShadow overflow-hidden"
      onClick={onClick}
    >
